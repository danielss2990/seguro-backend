...
public class ResourceExceptionHandler {
    ...
    public ResponseEntity<StandardError> entityNotFound(ResourceNotFoundException e, HttpServletRequest request){
        ...
        err.setTimestamp(Instant.MAX.now());
    ...
    public ResponseEntity<ValidationError> integrityConstraint(SQLIntegrityConstraintViolationException e, HttpServletRequest request){
